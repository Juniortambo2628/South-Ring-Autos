...
import { Wrench, Users, CheckCircle, Car, Clock } from 'lucide-react';
import statsBg from '../../../public/images/Stats-summary-strip-BG.jpg';
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
                    {facts.map((fact, index) => (
                        ...
                        >
                            <div className="text-white mb-4 flex justify-center transform group-hover:scale-110 transition-transform">
                                {fact.icon}
                            </div>
