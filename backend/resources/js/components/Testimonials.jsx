...
const testimonials = [
    {
        ...
        content: "Excellent service! The team was professional and the engine scan was very detailed. Highly recommend South Ring Autos.",
    },
    {
        id: 2,
        name: 'Sarah M.',
        ...
        content: "Transparent costing and great turnaround time. Finally found a mechanic I can trust in Karen.",
        featured: true
    },
    {
        id: 3,
        ...
        content: "They fixed my transmission issues when others couldn't. Expert technicians who know what they're doing.",
    }
];
                    ...
                    {testimonials.map((t) => (
                        <div key={t.id} className="p-10 bg-slate-50 border-b-4 border-red-600 hover:bg-white hover:shadow-2xl transition-all duration-300 flex flex-col items-center text-center">
                            ...
                            <div className="relative">
                                ...
                                <p className="text-slate-500 text-sm italic leading-relaxed font-medium relative z-1">
                                    "{t.content}"
                                </p>
                            </div>
                        </div>
